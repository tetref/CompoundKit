...
#[derive(Debug)]
pub struct CompoundKitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CompoundKitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CompoundKit processing");
    
    let mut processor = CompoundKitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CompoundKitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CompoundKitProcessor::new(false);
